...
// ---- 2. the z-index that now means something ------------------------
out.particleZ = st.canvas.style.zIndex;
out.speedZ = st.speedCanvas.style.zIndex;
// Dragging the layer up the list reassigns layerId; the canvas has to
// follow, or the stacking it now participates in goes stale.
LAYERS.Wind.layerId = 3;
W._refreshRunState();
out.zAfterReorder = st.canvas.style.zIndex;
